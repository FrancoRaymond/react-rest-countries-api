...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 w-full z-30 max-w-[1440px]">
      <div className="header1 relative z-40 shadow-sm border-b border-gray-300 flex justify-between px-2 py-3 sm:px-4 md:px-10 lg:px-20">
      ...
      <div className="header2 relative z-10 px-2 py-3 sm:px-4 sm:flex sm:items-center sm:justify-between md:px-10 lg:px-20">
        <div className="flex gap-3 shadow-md shadow-gray-100 items-center rounded-md outline-none p-2 my-2 grow max-w-96 sm:px-4">
          <img
        ...
        <select
          ...
          className="py-2 px-4 outline-none shadow-md shadow-gray-100 rounded-md mt-3 sm:mt-0 overflow-hidden transition-all duration-300 ease-in-out"
        >
